...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Atribuição dos dados às classes ( se tornou inútil, mas deu MUITO trabalho, então vou deixar comentado aqui);
    $curriculum = null;
    try {
    ...
    try {
        ...
        $curriculum->setPersonalInformation($personalInformation);
    } catch (Exception $e) {
    ...
    if (!empty($data["skills"]["softSkills"]) || !empty($data["skills"]["softSkills"])) {
        try {
